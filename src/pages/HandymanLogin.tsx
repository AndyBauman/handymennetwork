      ...
      <div className="container px-4 py-12 mx-auto">
        <div className="max-w-md mx-auto">
          <div className="mb-8 text-center">
            <h1 className="mb-2 text-3xl font-bold">Handyman Login</h1>
          ...
          <div className="p-4 mt-6 text-center">
            <p className="text-gray-600">
              Don't have an account? <Link to="/handyman-signup" className="text-brand-blue hover:underline">Join Now</Link>
            </p>
          </div>
        </div>
      </div>
